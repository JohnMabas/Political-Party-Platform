...
const products = [
  { id: 1, name: 'Yard Banner — "FUP"', price: 1500, category: 'Banners', img: '🪧', desc: 'Corrugated banner with the Federal Unity Party emblem. Made in Nigeria.' },
  { id: 2, name: 'Banner Stand', price: 800, category: 'Banners', img: '🗂', desc: 'Wire H-frame stand that holds a single banner securely.' },
  { id: 3, name: 'FUP T-Shirt', price: 2500, category: 'Apparel', img: '👕', desc: 'Soft cotton tee with the party seal. Sizes S–3XL.' },
  { id: 4, name: 'Ankara Tote Bag', price: 2000, category: 'Apparel', img: '👜', desc: 'Heavy canvas tote with Nigerian-inspired pattern for market days and rallies.' },
  { id: 5, name: 'Bumper Sticker (5-pack)', price: 1200, category: 'Stickers', img: '🚗', desc: 'Weatherproof bumper stickers. Five to a pack, share the rest.' },
  { id: 6, name: 'Button / Pin Set', price: 1000, category: 'Stickers', img: '🔘', desc: 'Three enamel pins — party seal, ballot-box, and "One Nigeria" editions.' },
  { id: 7, name: 'Coffee Mug', price: 1800, category: 'Apparel', img: '☕', desc: 'Ceramic mug for the long organising days.' },
  { id: 8, name: 'Postcard Pack (12)', price: 2200, category: 'Stationery', img: '✉️', desc: 'Write-your-own postcards for your street or your team.' },
]
      ...
      <section className="border-b border-border bg-primary text-white">
        <div className="container-site py-12">
          ...
          <p className="mt-3 max-w-2xl text-white/75">
            Banners, shirts, and stickers — all made in Nigeria where possible and priced to help, not to profit.
          </p>
        </div>
      </section>
          ...
          {products.map((p) => (
            <Card key={p.id} className="flex flex-col p-4">
              ...
              <div className="mt-3 flex items-center justify-between">
                <span className="font-serif text-lg font-bold text-primary">₦{p.price.toLocaleString()}</span>
          ...
          <div className="sticky bottom-4 mt-8 rounded border border-border bg-surface shadow-lg p-5">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-ink-muted">{Object.values(cart).reduce((a, b) => a + b, 0)} items · <strong className="text-ink">₦{total.toLocaleString()}</strong></p>
              </div>
